...
**Built-in:** `CkanClient`, `DcatClient`, `SparqlDcatClient`, `DataJsonClient`, `SocrataClient`, `OpenDataSoftClient`, `ArcGisClient`, `OgcRecordsClient`, `StacClient` (Collections only), and `SdmxClient` (dataflows only).
